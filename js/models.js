...
class StoryList {
	...
	async removeStory(user, storyId) {
		...
		// performt he same for user's list of stories & their favorites:
...
class User {
   ...
   */
	...
	// Update API with favorite / non - favorite.
	// - newState: "add" or "remove"
	// - story: the story instance to make favorite/non favorite
	...
	// return true/false if given story instance is favorite of user:
